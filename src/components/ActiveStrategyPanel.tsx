...
export const ActiveStrategyPanel: React.FC<ActiveStrategyPanelProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950/40 rounded-2xl p-4 border border-indigo-500/20 shadow-xl flex flex-col justify-between h-full">
      <div>
